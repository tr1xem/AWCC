...
struct {
	...
	.ModeNames = (const char *[]){[AWCCModeQuiet] = "Quiet",
...
void Initialize(void) { AWCCACPI.Initialize(); }

void Deinitialize(void) {}

AWCCBoost_t GetCpuBoost(void) { return GetFanBoost(AWCCFanCPU); }

AWCCBoost_t GetGpuBoost(void) { return GetFanBoost(AWCCFanGPU); }

void SetCpuBoost(AWCCBoost_t boost) { SetFanBoost(AWCCFanCPU, boost); }

void SetGpuBoost(AWCCBoost_t boost) { SetFanBoost(AWCCFanGPU, boost); }
...
void SetMode(enum AWCCMode_t mode) { AWCCACPI.SetMode(mode); }

enum AWCCMode_t GetMode(void) { return AWCCACPI.GetMode(); }
