...
const char *AcpiUtils::getPrefix() {
    ...
    if (deviceName.contains("Alienware Aurora R9") ||
        ...
        deviceName.contains("G3 3590") || deviceName.contains("G5 5590") ||
        ...
        deviceName.contains("Alienware Aurora R15") ||
        deviceName.contains("Alienware Aurora R12") ||
        deviceName.contains("Alienware Aurora Ryzen Edition R14") ||
        ...
        deviceName.contains("Alienware Aurora R11") ||
        deviceName.contains("Alienware Aurora R13") ||
